...
<Box {...$$props} {styles} {style} theme={$theme}>
  <Box id="top" role="document">
    ...
    <main role="main">
      <section id="text">
        <header>
          <Heading as="h1" color="color.primary">Text</Heading>
        </header>
        <article id="text__headings">
          <header>
            <Heading as="h1" color="color.primary">Headings</Heading>
          </header>
          <div>
            <Heading as="h1" color="color.primary">Heading 1</Heading>
        ...
        <article id="text__paragraphs">
          <header>
            <Heading as="h1" color="color.primary">Paragraphs</Heading>
          </header>
          <div>
            <p>
        ...
        <article id="text__blockquotes">
          <header>
            <Heading as="h1" color="color.primary">Blockquotes</Heading>
          </header>
          <div>
            <blockquote>
              <p>
        ...
        <article id="text__lists">
          <header>
            <Heading as="h1" color="color.primary">Lists</Heading>
          </header>
          <div>
            <Heading as="h3">Definition list</Heading>
            <dl>
        ...
        <article id="text__hr">
          <header>
            <Heading as="h1" color="color.primary">Horizontal rules</Heading>
          </header>
          <div>
            <hr />
          </div>
        ...
        <article id="text__tables">
          <header>
            <Heading as="h1" color="color.primary">Tabular data</Heading>
          </header>
          <table>
        ...
        <article id="text__inline">
          <header>
            <Heading as="h1" color="color.primary">Inline elements</Heading>
          </header>
          <div>
            <p>
        ...
        <article id="text__comments">
          <header>
            <Heading as="h1" color="color.primary">HTML Comments</Heading>
          </header>
          <div>
            <p>
      ...
      <section id="embedded">
        <header>
          <Heading as="h1" color="color.primary">Embedded content</Heading>
        </header>
        ...
        <article id="embedded__svg">
          <header>
            <Heading as="h2">Inline SVG</Heading>
          </header>
          <div>
      ...
      <section id="forms">
        <header>
          <Heading as="h1" color="color.primary">Form elements</Heading>
        </header>
        <form>
