...
interface NexusPrismaInputs {
  Query: {
    users: {
  filtering: 'id' | 'name' | 'email' | 'password' | 'collections' | 'role' | 'createdAt' | 'updatedAt' | 'AND' | 'OR' | 'NOT' | 'profile'
  ordering: 'id' | 'name' | 'email' | 'password' | 'role' | 'createdAt' | 'updatedAt'
}
    profiles: {
  filtering: 'id' | 'phone' | 'companyName' | 'website' | 'userId' | 'updatedAt' | 'AND' | 'OR' | 'NOT' | 'user'
  ordering: 'id' | 'companyName' | 'website' | 'userId' | 'user' | 'updatedAt'
}
    phones: {
  ...
  ordering: 'id' | 'type' | 'number' | 'profileId' | 'profile'
    ...
    works: {
  filtering: 'id' | 'catalogId' | 'title' | 'medium' | 'dimensions' | 'date' | 'type' | 'price' | 'image' | 'category' | 'published' | 'createdAt' | 'updatedAt' | 'collectionId' | 'AND' | 'OR' | 'NOT' | 'collection'
  ordering: 'id' | 'catalogId' | 'title' | 'medium' | 'dimensions' | 'date' | 'type' | 'price' | 'category' | 'published' | 'createdAt' | 'updatedAt' | 'collectionId' | 'collection'
}
    images: {
  ...
  ordering: 'id' | 'name' | 'url' | 'width' | 'height' | 'createdAt' | 'updatedAt' | 'workId' | 'work'
    ...
    collections: {
  filtering: 'id' | 'name' | 'works' | 'createdAt' | 'updatedAt' | 'users' | 'AND' | 'OR' | 'NOT'
